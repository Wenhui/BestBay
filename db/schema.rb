...
ActiveRecord::Schema.define(:version => 20121118155521) do
  ...
  create_table "bids", :force => true do |t|
    ...
    t.boolean  "notifiy",      :default => false
    t.boolean  "inBid_notify", :default => false
  end
  ...
  create_table "items", :force => true do |t|
    ...
    t.float    "highest_price",        :default => 0.0
    t.integer  "winner_id"
